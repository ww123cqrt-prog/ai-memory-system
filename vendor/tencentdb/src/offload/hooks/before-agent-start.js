 ...
 */
import { readMmd, writeMmd, deleteMmd } from "../storage.js";
/**
...
export function normalizeJudgment(raw) {
    ...
    return {
        ...
        continuationMmdFile: typeof raw.continuationMmdFile === "string" ? raw.continuationMmdFile : undefined,
        newTaskLabel: typeof raw.newTaskLabel === "string" ? raw.newTaskLabel : undefined,
        isLongTask: Boolean(raw.isLongTask),
    };
}
export async function handleTaskTransition(stateManager, judgment, logger) {
