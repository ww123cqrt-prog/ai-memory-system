...
export interface PluginConfig {
     ...
     */
    l3TiktokenEncoding?: "gpt2" | "r50k_base" | "p50k_base" | "p50k_edit" | "cl100k_base" | "o200k_base";
    /**
...
export declare const PLUGIN_DEFAULTS: {
    ...
    readonly forceTriggerThreshold: 4;
    readonly defaultContextWindow: 200000;
    readonly maxPairsPerBatch: 20;
    readonly l2NullThreshold: 4;
    readonly l2TimeoutSeconds: 300;
    /** If L2 leaves entries in node_id="wait", retry after this many seconds */
    readonly l2WaitRetrySeconds: 120;
    /** When true, time-based L2 only fires if some node_id=null row is newer than last L2 */
    readonly l2TimeTriggerRequiresNewOffload: true;
    readonly mildOffloadRatio: 0.5;
    readonly mildOffloadScanRatio: 0.7;
    readonly mildScoreTopRatio: 0.4;
    readonly mildCurrentTaskRatio: 0.8;
    readonly aggressiveCompressRatio: 0.85;
    readonly aggressiveDeleteRatio: 0.4;
    /** Emergency trigger: when tokens >= contextWindow * 0.95, fire emergency */
    readonly emergencyCompressRatio: 0.95;
    /** Emergency target: delete until tokens <= contextWindow * 0.6 */
    readonly emergencyTargetRatio: 0.6;
    readonly mmdMaxTokenRatio: 0.2;
    readonly l3TokenCountMode: "tiktoken";
    readonly l3TiktokenEncoding: "cl100k_base";
    readonly defaultSystemOverheadRatio: 0.12;
};
